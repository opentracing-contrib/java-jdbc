...
public class TracingStatement implements Statement {
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    Scope scope = buildScope("Query", sql, connectionInfo, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
  ...
  public int executeUpdate(String sql) throws SQLException {
    Scope scope = buildScope("Update", sql, connectionInfo, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
  ...
  public boolean execute(String sql) throws SQLException {
    Scope scope = buildScope("Execute", sql, connectionInfo, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
  ...
  private Scope buildScopeForBatch() {
    ...
    return buildScope("Batch", sqlBuilder.toString(), connectionInfo, withActiveSpanOnly,
