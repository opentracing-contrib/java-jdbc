...
public class TracingStatement implements Statement {
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    Span span = buildSpan("Query", sql, connectionInfo, withActiveSpanOnly, ignoreStatements,
        tracer);
  ...
  public int executeUpdate(String sql) throws SQLException {
    Span span = buildSpan("Update", sql, connectionInfo, withActiveSpanOnly, ignoreStatements,
        tracer);
    try (Scope ignored = tracer.activateSpan(span)) {
  ...
  public boolean execute(String sql) throws SQLException {
    Span span = buildSpan("Execute", sql, connectionInfo, withActiveSpanOnly, ignoreStatements,
        tracer);
    try (Scope ignored = tracer.activateSpan(span)) {
