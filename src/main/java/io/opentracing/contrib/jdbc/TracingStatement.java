...
public class TracingStatement implements Statement {
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    Scope scope = buildScope("Query", sql, dbType, dbUser, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
  ...
  public int executeUpdate(String sql) throws SQLException {
    Scope scope = buildScope("Update", sql, dbType, dbUser, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
  ...
  public boolean execute(String sql) throws SQLException {
    Scope scope = buildScope("Execute", sql, dbType, dbUser, withActiveSpanOnly, ignoredStatements,
        tracer);
    try {
